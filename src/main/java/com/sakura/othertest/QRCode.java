...
public class QRCode {
        ...
        public static void main(String[] args) throws IOException, NotFoundException {
            ...
            // logo图片路径(这是相对路径)
            File logoFile = new File("C:\\Users\\iotcomm-001\\Desktop\\28.png");
            System.out.println(logoFile.getAbsolutePath());
            BufferedImage image = QRCode.createQRCodeWithLogo(data, logoFile);
            // 生成图片 不需要的话注释即可
...
//            System.err.println(base64Img);
        ...
        /**
         * Create qrcode with default settings and img
         *
         * @author stefli
         * @param data
         * @param logoFile
        ...
        /**
         * Create qrcode with default charset and img
         *
         * @author stefli
         * @param data
         * @param width
        ...
        /**
         * Create qrcode with specified charset and img
         *
         * @author stefli
         * @param data
         * @param charset
        ...
        /**
         * Create qrcode with specified hint and img
         *
         * @author stefli
         * @param data
         * @param charset
